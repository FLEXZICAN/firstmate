...
- [docs/windows-gitbash.md](docs/windows-gitbash.md) - running firstmate on Windows under Git Bash: the substrate differences, how crewmate spawn diverges, and the known gaps.
