...
tests/fm-backend-herdr-launcher-workspace-e2e.test.sh	fails on Windows: a primary-shaped spawn with no herdr parent does not complete
...
tests/fm-busy-adapter-wiring.test.sh	fails on Windows: agent_settled classifies an idle pi-ext pane as busy fm-spawn
...
tests/fm-public-followup.test.sh	fails on Windows: the private request context is not retained
...
tests/fm-startup-memory-budget.test.sh	fails on Windows: default materialization should stay quiet but reports a MISSING tool from the fixture PATH
